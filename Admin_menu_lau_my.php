...
<body>
	...
	<table border="1" width="90%" bgcolor="#E2E2E2">
  		<tr bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC LẨU VÀ MỲ</td>
  		</tr>
  		<form name="search_lau_my" method="post" action="Lau_my_search.php">
  			<tr>
    			<td colspan="7">&nbsp; Tìm kiếm: <select name="lau_my">
  		...
  		<tr>
    		...
    		<td colspan="2" align="center"><a style="background-color:lightskyblue; color:black" href="Lau_my_them.php">Thêm món</a></td>
  		</tr>
  		<?php
 		for($i=2;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35" align="center"><a style="background-color:red; color:black" href="Lau_my_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37" align="center"><a style="background-color:yellow; color:black" href="Lau_my_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
