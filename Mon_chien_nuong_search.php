...
<body> 
	...
	<?php
		...
		$idmon=$_REQUEST["mon_chien_nuong"];
		$sql="Select * from `mon_chien_nuong` where id_mon=$idmon";
	...
	<table  border="1" width="90%" bgcolor="#E2E2E2">
  		...
  		<form name="search_com" method="post" action="Mon_chien_nuong_search.php">
  			<tr>
  		...
  		<tr>
    		...
    		<td colspan="2"><a style="background-color:lightskyblue; color:black" href="Mon_chien_nuong_them.php">Thêm món</a></td>
  		</tr>
  		<?php
  			for($i=1;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35"><a style="background-color:red; color:black" href="Mon_chien_nuong_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37"><a style="background-color:yellow; color:black" href="Mon_chien_nuong_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
