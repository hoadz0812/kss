...
<body>
	...
	<table border="1" width="90%" bgcolor="#E2E2E2">
  		...
  		<tr>
    		...
    		<td colspan="2" align="center"><a style="background-color:lightskyblue; color:black" href="Do_uong_them.php">Thêm món</a></td>
  		</tr>
  		<?php
 		for($i=2;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35" align="center"><a style="background-color:red; color:black" href="Do_uong_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37" align="center"><a style="background-color:yellow; color:black" href="Do_uong_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
