...
<body>
	...
	<div class="main" align="center">
		<form name="do_uong" method="post" action="Do_uong_them_save.php" enctype="multipart/form-data">
...
<script language="javascript">
	function check_input(){
		var txtTTA= document.do_uong.txtTTA.value;
		var txtTTV= document.do_uong.txtTTV.value;
		var txtGia= document.do_uong.txtGia.value;
		if(txtTTA=="" || txtTTV=="" || txtGia=="")
			alert("Bạn chưa nhập đủ dữ liệu. Hãy kiểm tra lại!");
		else{
			alert("Thêm món thành công!");
			document.do_uong.submit();
		}
