...
<body>
	<?php
        ...
        $sql_insert="INSERT INTO mon_chien_nuong (`id_mon`, `ten_tieng_anh`, `ten_tieng_viet`, `gia`, `hinh_anh`) VALUES (NULL, '$tta', '$ttv', '$gia', '$file_name_')";
        mysqli_query($conn, $sql_insert);
        header("Location: Mon_chien_nuong_them.php");
    ?>
</body>
</html>