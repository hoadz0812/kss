...
<body>
	...
	<div class="main" align="center">
		<form name="lau_my" method="post" action="Lau_my_them_save.php" enctype="multipart/form-data">
...
<script language="javascript">
	function check_input(){
		var txtTTA= document.lau_my.txtTTA.value;
		var txtTTV= document.lau_my.txtTTV.value;
		var txtGia= document.lau_my.txtGia.value;
		if(txtTTA=="" || txtTTV=="" || txtGia=="")
			alert("Bạn chưa nhập đủ dữ liệu. Hãy kiểm tra lại!");
		else{
			alert("Thêm món thành công!");
			document.lau_my.submit();
		}
