...
<body> 
	...
	<div class="menu">
		<ul>
			...
			<li><a href="Admin_menu_salad.php">Quản lý Menu ▼</a>
				<ul class="submenu">
	...
	<?php
		...
		$idmon=$_REQUEST["salad"];
		$sql_select_mon="Select * from `salad` where id_mon=$idmon";
	...
	<table  border="1" width="90%" bgcolor="#E2E2E2">
  		...
  		<tr>
    		...
    		<td colspan="2"><a href="Salad_them.php">Thêm món</a></td>
  		</tr>
  		<?php
  			for($i=1;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35"><a href="Salad_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37"><a href="Salad_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
