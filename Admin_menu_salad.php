...
<body>
	...
	$sql_select_sashimi="Select * from `salad`";
	...
	<table border="1" width="90%" bgcolor="#E2E2E2">
  		<tr bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC SALAD</td>
  		</tr>
  		<form name="search_salad" method="post" action="Salad_search.php">
  			<tr>
    			<td colspan="7">&nbsp; Tìm kiếm: <select name="salad">
  		...
  		<tr>
    		...
    		<td colspan="2" align="center"><a style="background-color:lightskyblue; color:black" href="Salad_them.php">Thêm món</a></td>
  		</tr>
  		<?php
 		for($i=2;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35" align="center"><a style="background-color:red; color:black" href="Salad_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37" align="center"><a style="background-color:yellow; color:black" href="Salad_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
