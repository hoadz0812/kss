...
<body>
	...
	<table border="0" align="center" width="80%" bgcolor="#E2E2E2">
		<tr height="50" bgcolor="#8A8A8A">
			<td colspan="2" align="center">THÊM TÀI KHOẢN</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center"><input type="button" value="  OK   " onClick="check_input()"> <input type="reset" value="RESET"></td>
		</tr>
	</table>
	</form>
	</div>
	...
	?>
	<div class="main" align="center">
	<table border="1" width="80%" bgcolor="#E2E2E2">
  		<tr height="50" bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC TÀI KHOẢN</td>
  		</tr>
  		<tr height="50">
    		<td width="38" align="center">STT</td>
    		<td width="400" align="center">Họ tên</td>
    		<td width="400" align="center">Tên đăng nhập</td>
			<td width="200" align="center">Mật khẩu</td>
    		<td colspan="3" align="center" width="400">Tùy Chọn</td>
  		</tr>
  		<?php
 		for($i=1;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr height="100">
			...
			<td align="center">●●●●●●●●●●</td>
    		<td width="40" align="center"><a style="background-color:red; color:black" href="Nguoi_dung_edit.php?id_nd=<?php echo $id[$i]?>">Sửa</a></td>
    		<td width="40" align="center"><a style="background-color:yellow; color:black" href="Nguoi_dung_del.php?id_nd=<?php echo $id[$i]?>">Xoá</a></td>
			<td width="70" align="center"><a style="background-color:greenyellow; color:black" href="Nguoi_dung_doimk.php?id_nd=<?php echo $id[$i]?>">Đổi mật khẩu</a></td>
  		</tr>
  		<?php
  			}
  		?>
