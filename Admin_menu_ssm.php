...
<body>
	...
	$sql_select_sashimi="Select * from `sashimi`";
	$result_se_mon=mysqli_query($conn,$sql_select_sashimi);
	$tong_bg=mysqli_num_rows($result_se_mon);
	$stt_mon=0;
	while($row=mysqli_fetch_object($result_se_mon))
	{
		$stt_mon++;
	...
	<table border="1" width="90%" bgcolor="#E2E2E2">
  		<tr height="50px" bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC SASHIMI VÀ SUSHI</td>
  		</tr>
  		<form name="search_sashimi" method="post" action="sashimi_search.php">
  			<tr>
    			<td colspan="7">&nbsp; Tìm kiếm: <select name="sashimi">
  		...
  		<tr>
    		...
    		<td colspan="2" align="center"><a style="background-color:lightskyblue; color:black" href="Sashimi_them.php">Thêm món</a></td>
  		</tr>
  		<?php
 		for($i=2;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35" align="center"><a style="background-color:red; color:black" href="sashimi_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37" align="center"><a style="background-color:yellow; color:black" href="sashimi_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
