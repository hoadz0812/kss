...
<body> 
	...
	<?php
		...
		$idmon=$_REQUEST["lau_my"];
		$sql="Select * from `lau_my` where id_mon=$idmon";
	...
	<table  border="1" width="90%" bgcolor="#E2E2E2">
  		...
  		<form name="search_com" method="post" action="Lau_my_search.php">
  			<tr>
  		...
  		<tr>
    		...
    		<td colspan="2"><a style="background-color:lightskyblue; color:black" href="Lau_my_them.php">Thêm món</a></td>
  		</tr>
  		<?php
  			for($i=1;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35"><a style="background-color:red; color:black" href="Lau_my_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37"><a style="background-color:yellow; color:black" href="Lau_my_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
