...
<body>
	...
	<div class="main" align="center">
		<form name="salad" method="post" action="Salad_them_save.php" enctype="multipart/form-data">
...
<script language="javascript">
	function check_input(){
		var txtTTA= document.salad.txtTTA.value;
		var txtTTV= document.salad.txtTTV.value;
		var txtGia= document.salad.txtGia.value;
		if(txtTTA=="" || txtTTV=="" || txtGia=="")
			alert("Bạn chưa nhập đủ dữ liệu. Hãy kiểm tra lại!");
		else{
			alert("Thêm món thành công!");
			document.salad.submit();
		}
