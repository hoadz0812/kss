...
<body> 
	...
	<?php
		...
		$idmon=$_REQUEST["sashimi"];
		$sql_select_mon="Select * from `sashimi` where id_mon=$idmon";
		$result_se_mon=mysqli_query($conn,$sql_select_mon);
	...
	<table  border="1" width="90%" bgcolor="#E2E2E2">
  		<tr height="50" bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC SASHIMI</td>
  		</tr>
  		...
  		<tr>
    		...
    		<td colspan="2"><a style="background-color:lightskyblue; color:black" href="Sashimi_them.php">Thêm món</a></td>
  		</tr>
  		<?php
  			for($i=1;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35"><a style="background-color:red; color:black" href="sashimi_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37"><a style="background-color:yellow; color:black" href="sashimi_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
