...
<body>
	<?php
        ...
        $sql_insert_sashimi="INSERT INTO sashimi (`id_mon`, `ten_tieng_anh`, `ten_tieng_viet`, `gia`, `hinh_anh`) VALUES (NULL, '$tta', '$ttv', '$gia', '$file_name_')";
        mysqli_query($conn, $sql_insert_sashimi);
        header("Location: Sashimi_them.php");
    ?>
</body>
</html>