...
<body> 
	...
	<?php
		...
		$idmon=$_REQUEST["do_uong"];
		$sql="Select * from `do_uong` where id_mon=$idmon";
	...
	<table  border="1" width="90%" bgcolor="#E2E2E2">
  		<tr height="50" bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC ĐỒ UỐNG</td>
  		</tr>
  		<form name="search_do_uong" method="post" action="Do_uong_search.php">
  			<tr>
    			<td colspan="7">Tìm kiếm <select name="do_uong">
  		...
  		<tr>
    		...
    		<td colspan="2"><a style="background-color:lightskyblue; color:black" href="Do_uong_them.php">Thêm món</a></td>
  		</tr>
  		<?php
  			for($i=1;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35"><a style="background-color:red; color:black" href="Do_uong_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37"><a style="background-color:yellow; color:black" href="Do_uong_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
