...
<body>
	...
	$sql="Select * from `mon_chien_nuong`";
	...
	<table border="1" width="90%" bgcolor="#E2E2E2">
  		<tr bgcolor="#8A8A8A">
    		<td colspan="7" align="center">DANH MỤC MÓN CHIÊN VÀ MÓN NƯỚNG</td>
  		</tr>
  		<form name="search_mon_chien_nuong" method="post" action="Mon_chien_nuong_search.php">
  			<tr>
    			<td colspan="7">&nbsp; Tìm kiếm: <select name="mon_chien_nuong">
  		...
  		<tr>
    		...
    		<td colspan="2" align="center"><a style="background-color:lightskyblue; color:black" href="Mon_chien_nuong_them.php">Thêm món</a></td>
  		</tr>
  		<?php
 		for($i=2;$i<=$tong_bg; $i++)
  			{
  		...
  		<tr>
    		...
    		<td width="35" align="center"><a style="background-color:red; color:black" href="Mon_chien_nuong_edit.php?idmon=<?php echo $id_mon[$i]?>">Sửa</a></td>
    		<td width="37" align="center"><a style="background-color:yellow; color:black" href="Mon_chien_nuong_del.php?idmon=<?php echo $id_mon[$i]?>">Xoá</a></td>
  		</tr>
  		<?php
  			}
  		?>
