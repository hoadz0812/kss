...
<body>
	...
	<div class="main" align="center">
		<form name="sashimi" method="post" action="Sashimi_them_save.php" enctype="multipart/form-data">
...
<script language="javascript">
	function check_input(){
		var txtTTA= document.sashimi.txtTTA.value;
		var txtTTV= document.sashimi.txtTTV.value;
		var txtGia= document.sashimi.txtGia.value;
		if(txtTTA=="" || txtTTV=="" || txtGia=="")
			alert("Bạn chưa nhập đủ dữ liệu. Hãy kiểm tra lại!");
		else{
			alert("Thêm món thành công!");
			document.sashimi.submit();
		}
